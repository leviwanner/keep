...
```plaintext
PRIVATE_KEY=YOUR_SUPER_SECRET_EDIT_PASSWORD
PUBLIC_KEY=YOUR_SUPER_SECRET_VIEW_PASSWORD
# VAPID_PUBLIC=PASTE_GENERATED_VAPID_PUBLIC_KEY_HERE
# VAPID_PRIVATE=PASTE_GENERATED_VAPID_PRIVATE_KEY_HERE
```
**Remember to replace `YOUR_SUPER_SECRET_EDIT_PASSWORD` and `YOUR_SUPER_SECRET_VIEW_PASSWORD` with strong, unique passwords of your choice. I reccomend using a tool like this [password generator](https://1password.com/password-generator)**
